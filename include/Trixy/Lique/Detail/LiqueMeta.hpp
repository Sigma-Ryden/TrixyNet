...
template <class Tensor> struct is_lvector : disjunction<is_vector<Tensor>, is_lock_vector<Tensor>> {};
template <class Tensor> struct is_lmatrix : disjunction<is_matrix<Tensor>, is_lock_matrix<Tensor>> {};
